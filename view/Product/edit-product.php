          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form action="../../action/products/edit_product.php" class="mx-1 mx-md-4" method="post" enctype="multipart/form-data" >
                    <input type="hidden" name="id" value="<?php echo $product['id'] ?>">
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                      <label class="form-label" for="form3Example1c">Name</label>
                      <input type="text" name="name"  value="<?php echo $product['name'] ?>"  id="form3Example1c" class="form-control" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div data-mdb-input-init class="form-outline flex-fill mb-0">
                      ...
                      <input type="text" name="price"  value="<?php echo $product['price'] ?>" id="form3Example3c" class="form-control" />
